...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire(`Hallo Pacar ${sender} :)` , "Aku ada pertanyaan nih buat kamu sayangg", "question").then(function () {
    Swal.fire("Jawab yang jujur ya!").then(function () {
      Swal.fire("Awas aja kalau kamu bohong", "", "error").then(function () {
        ...
        const {
          ...
          title: 'Masukin nama kamu dulu dong sayangg :)',
          input: 'text',
          inputLabel: '',
          showCancelButton: true,
          inputValidator: (value) => {
            if (!value) {
              return 'Isi dulu dong babyyy'
            } else {
              nama = value;
            }
          }
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}% :) :*`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuhu :( iya ${sender} juga kangen ${nama}, makasihhh yaa sayangg :)`).then(function () {
                          Swal.fire('Terakhir deh sayang').then(function () {
                            Swal.fire('Coba klik ikon hati di paling bawah dong')
                          })
                        })
                      } else if (result.isDenied) {
                        Swal.fire('yahhh, masa gak kangen sama pacar sendiri :( jahat ihh', '', 'error').then(function () {
